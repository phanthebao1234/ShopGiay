<?php 
    class Menu {
        ...
        public function insertMenu($menu_name, $menu_status, $menu_desc) {
            $db = new connect();
            $query = "insert into menu ( menu_name, menu_desc, menu_status)
            value ('$menu_name', '$menu_desc', $menu_status)";
            $db -> exec($query);
        }

        public function updateMenu($menu_id, $menu_name, $menu_desc, $menu_status = 1) {
            $db = new connect();
            $query = "update menu
