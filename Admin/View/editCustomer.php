...
<a class="btn btn-primary" href="index.php?action=customer">Hủy</a>
    ...
    <form>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="email" disabled class="form-control" id="customer_email" name="customer_email" value="<?php if (isset($customer_id)) echo $customer_email ?>">
            ...
            <div class="col-md-12">
                <div class="float-end">
                    <?php
                    if ($act == 'insert') {
                        echo '<button id="submit_create" type="button" class="btn btn-primary btn-lg">Thêm khách hàng</button>';
                    } else if ($act == 'update') {
                        echo '<button id="submit_update" type="button" class="btn btn-primary btn-lg">Cập nhật khách hàng</button>';
                    }
                    ?>
                </div>
            </div>
