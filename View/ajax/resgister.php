...
$customer_code_address = htmlspecialchars(trim($_POST['customer_code_address']));
...
if (empty($customer_firstname) || empty($customer_lastname) || empty($customer_email) || empty($customer_pass) || empty($customer_phone)) {
    ...
    if($count['count'] > 0) {
        ...
        $customer->regristerCustomer($customer_firstname, $customer_lastname, $customer_render, $customer_birthday, $customer_phone, $customer_email, $customer_pass, $customer_address, $customer_image, $customer_code_address);
